...
namespace FDTS.Models.Startup
{
    ...
    public class ApplicationUserManager : UserManager<Users, string>
    {
        ...
        {
            var userStores = new UserStores(context.Get<FinancialdocumenttrackersystemEntities>());
    ...
    public class ApplicationSignInManager : SignInManager<Users, string>
    {
        ...
        {
            var userByEmail = UserManager.FindByEmail(userName);
            userName = userByEmail == null ? userName : userByEmail.UserName;
    ...
    public class ApplicationRoleManager : RoleManager<UserRoles>
    {
        ...
        {
            var roleStore = new RoleStores(context.Get<FinancialdocumenttrackersystemEntities>());
